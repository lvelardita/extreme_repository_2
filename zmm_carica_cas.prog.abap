...
* Progetto    :
*---------------------------------------------------------------------*
* Titolo      : Caricamento codici CAS
*---------------------------------------------------------------------*
* Creato da   : Programmatore
...
REPORT zmm_carica_cas NO STANDARD PAGE HEADING line-size 150.
...
SELECT-OPTIONS: s_casnr FOR  T610c-casnr.

SELECTION-SCREEN SKIP.

PARAMETERS: p_file LIKE rlgrap-filename
                   DEFAULT 'C:\migeuti\codici_cas.txt' OBLIGATORY.
